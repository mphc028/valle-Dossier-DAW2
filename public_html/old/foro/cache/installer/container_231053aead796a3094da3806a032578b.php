...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['cache.driver'] = new \phpbb\cache\driver\file('/home/u117678300/public_html/foro/install/../cache/installer/');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, '/home/u117678300/public_html/foro/install/../', $this->get('template'));
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator($this->get('filesystem'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.file_updater.compress'] = new \phpbb\install\helper\file_updater\compression_file_updater($this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.file_updater.file'] = new \phpbb\install\helper\file_updater\file_updater($this->get('filesystem'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.file_updater.ftp'] = new \phpbb\install\helper\file_updater\ftp_file_updater($this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.helper.config'] = new \phpbb\install\helper\config($this->get('filesystem'), $this->get('php_ini'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.helper.container_factory'] = new \phpbb\install\helper\container_factory($this->get('language'), $this->get('request'), $this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.helper.database'] = new \phpbb\install\helper\database($this->get('filesystem'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.helper.install_helper'] = new \phpbb\install\helper\install_helper('/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        $this->services['installer.helper.iohandler_ajax'] = $instance = new \phpbb\install\helper\iohandler\ajax_iohandler($this->get('path_helper'), $this->get('request'), $this->get('template'), $this->get('router'), '/home/u117678300/public_html/foro/install/../');
    ...
    {
        return $this->services['installer.helper.update_helper'] = new \phpbb\install\helper\update_helper('/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.install_data.add_bots'] = new \phpbb\install\module\install_data\task\add_bots($this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.container_factory'), $this->get('language'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.install_data.create_search_index'] = new \phpbb\install\module\install_data\task\create_search_index($this->get('config'), $this->get('installer.helper.container_factory'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.install_database.add_config_settings'] = new \phpbb\install\module\install_database\task\add_config_settings($this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.container_factory'), $this->get('language'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.install_database.add_default_data'] = new \phpbb\install\module\install_database\task\add_default_data($this->get('installer.helper.database'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.container_factory'), $this->get('language'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.install_database.add_tables'] = new \phpbb\install\module\install_database\task\add_tables($this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('filesystem'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.install_database.create_schema_file'] = new \phpbb\install\module\install_database\task\create_schema_file($this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('filesystem'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.install_database.set_up_database'] = new \phpbb\install\module\install_database\task\set_up_database($this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('filesystem'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.install_filesystem.create_config_file'] = new \phpbb\install\module\install_filesystem\task\create_config_file($this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../', 'php', array());
    }
    ...
    {
        return $this->services['installer.install_finish.install_extensions'] = new \phpbb\install\module\install_finish\task\install_extensions($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.install_finish.notify_user'] = new \phpbb\install\module\install_finish\task\notify_user($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.obtain_data.update_files'] = new \phpbb\install\module\obtain_data\task\obtain_update_files($this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.requirements.check_filesystem'] = new \phpbb\install\module\requirements\task\check_filesystem($this->get('filesystem'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.requirements.check_filesystem_update'] = new \phpbb\install\module\requirements\task\check_filesystem($this->get('filesystem'), $this->get('installer.helper.iohandler'), '/home/u117678300/public_html/foro/install/../', 'php', false);
    }
    ...
    {
        return $this->services['installer.requirements.update_requirements'] = new \phpbb\install\module\requirements\task\check_update($this->get('installer.helper.container_factory'), $this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.update_database.update_extensions'] = new \phpbb\install\module\update_database\task\update_extensions($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.update_database.update_task'] = new \phpbb\install\module\update_database\task\update($this->get('installer.helper.container_factory'), $this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('language'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.update_filesystem.check_task'] = new \phpbb\install\module\update_filesystem\task\file_check($this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['installer.update_filesystem.diff_files'] = new \phpbb\install\module\update_filesystem\task\diff_files($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.update_filesystem.update_files'] = new \phpbb\install\module\update_filesystem\task\update_files($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.file_updater.factory'), $this->get('installer.helper.update_helper'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['language.helper.language_file'] = new \phpbb\language\language_file_helper('/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['language.loader'] = new \phpbb\language\language_file_loader('/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.convert'] = new \phpbb\convert\controller\convertor($this->get('cache.driver'), $this->get('installer.helper.container_factory'), $this->get('installer.helper.database'), $this->get('phpbb.installer.controller.helper'), $this->get('installer.helper.install_helper'), $this->get('installer.helper.iohandler_factory'), $this->get('language'), $this->get('installer.navigation.provider'), $this->get('request'), $this->get('template'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.helper'] = new \phpbb\install\controller\helper($this->get('installer.helper.config'), $this->get('language'), $this->get('language.helper.language_file'), $this->get('installer.navigation.provider'), $this->get('template'), $this->get('path_helper'), $this->get('request'), $this->get('symfony_request'), $this->get('router'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.status'] = new \phpbb\install\controller\timeout_check($this->get('phpbb.installer.controller.helper'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.welcome'] = new \phpbb\install\controller\installer_index($this->get('phpbb.installer.controller.helper'), $this->get('language'), $this->get('template'), '/home/u117678300/public_html/foro/install/../');
    }
    ...
    {
        return $this->services['router'] = new \phpbb\routing\router($this, $this->get('routing.chained_resources_locator'), $this->get('routing.delegated_loader'), 'php', '/home/u117678300/public_html/foro/install/../cache/installer/');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper($this->get('config'), $this->get('router'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), '/home/u117678300/public_html/foro/install/../', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\installer_resources_locator($this->get('filesystem'), '/home/u117678300/public_html/foro/install/../', 'installer');
    }
    ...
    {
        return $this->services['template'] = new \phpbb\template\twig\twig($this->get('path_helper'), $this->get('config'), $this->get('template_context'), $this->get('template.twig.environment'), '/home/u117678300/public_html/foro/install/../cache/installer/twig/', NULL, $this->get('template.twig.extensions.collection'));
    }
    ...
    {
        $this->services['template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), '/home/u117678300/public_html/foro/install/../cache/installer/twig/', NULL, $this->get('template.twig.loader'), NULL, array());
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000020ae325b000000005b5066ad(
    ...
    {
        return array(
            'core.root_path' => '/home/u117678300/public_html/foro/install/../',
            'core.php_ext' => 'php',
            'core.environment' => 'installer',
            'core.debug' => false,
            'core.cache_dir' => '/home/u117678300/public_html/foro/install/../cache/installer/',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'core.template.cache_path' => '/home/u117678300/public_html/foro/install/../cache/installer/twig/',
...
class phpbbtemplatetwiglexer_0000000020ae325b000000005b5066ad extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a1155d782ec5537838806 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a1155d782ece836886852 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a1155d782ea8360140674 = array(
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, 'set_environment', array('env' => $env), $this->initializer5a1155d782ece836886852);

        return $this->valueHolder5a1155d782ec5537838806->set_environment($env);
    }
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a1155d782ece836886852);

        return $this->valueHolder5a1155d782ec5537838806->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a1155d782ece836886852);

        return $this->valueHolder5a1155d782ec5537838806->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a1155d782ece836886852 = $initializer;
    }
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, '__get', array('name' => $name), $this->initializer5a1155d782ece836886852);

        if (isset(self::$publicProperties5a1155d782ea8360140674[$name])) {
            return $this->valueHolder5a1155d782ec5537838806->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a1155d782ec5537838806;
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a1155d782ece836886852);
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, '__isset', array('name' => $name), $this->initializer5a1155d782ece836886852);
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, '__unset', array('name' => $name), $this->initializer5a1155d782ece836886852);
    ...
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, '__clone', array(), $this->initializer5a1155d782ece836886852);

        $this->valueHolder5a1155d782ec5537838806 = clone $this->valueHolder5a1155d782ec5537838806;
    }

    public function __sleep()
    {
        $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, '__sleep', array(), $this->initializer5a1155d782ece836886852);

        return array('valueHolder5a1155d782ec5537838806');
    }
    ...
    {
        return $this->initializer5a1155d782ece836886852;
    }
    ...
    {
        return $this->initializer5a1155d782ece836886852 && $this->initializer5a1155d782ece836886852->__invoke($this->valueHolder5a1155d782ec5537838806, $this, 'initializeProxy', array(), $this->initializer5a1155d782ece836886852);
    }
    ...
    {
        return null !== $this->valueHolder5a1155d782ec5537838806;
    }
    ...
    {
        return $this->valueHolder5a1155d782ec5537838806;
    }
