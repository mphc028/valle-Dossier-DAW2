...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001b83173e000000005b290f71(
...
class phpbbtemplatetwiglexer_000000001b83173e000000005b290f71 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a115793d5240139078767 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a115793d5252742459785 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a115793d5204770184188 = array(
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, 'set_environment', array('env' => $env), $this->initializer5a115793d5252742459785);

        return $this->valueHolder5a115793d5240139078767->set_environment($env);
    }
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a115793d5252742459785);

        return $this->valueHolder5a115793d5240139078767->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a115793d5252742459785);

        return $this->valueHolder5a115793d5240139078767->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a115793d5252742459785 = $initializer;
    }
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, '__get', array('name' => $name), $this->initializer5a115793d5252742459785);

        if (isset(self::$publicProperties5a115793d5204770184188[$name])) {
            return $this->valueHolder5a115793d5240139078767->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a115793d5240139078767;
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a115793d5252742459785);
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, '__isset', array('name' => $name), $this->initializer5a115793d5252742459785);
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, '__unset', array('name' => $name), $this->initializer5a115793d5252742459785);
    ...
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, '__clone', array(), $this->initializer5a115793d5252742459785);

        $this->valueHolder5a115793d5240139078767 = clone $this->valueHolder5a115793d5240139078767;
    }

    public function __sleep()
    {
        $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, '__sleep', array(), $this->initializer5a115793d5252742459785);

        return array('valueHolder5a115793d5240139078767');
    }
    ...
    {
        return $this->initializer5a115793d5252742459785;
    }
    ...
    {
        return $this->initializer5a115793d5252742459785 && $this->initializer5a115793d5252742459785->__invoke($this->valueHolder5a115793d5240139078767, $this, 'initializeProxy', array(), $this->initializer5a115793d5252742459785);
    }
    ...
    {
        return null !== $this->valueHolder5a115793d5240139078767;
    }
    ...
    {
        return $this->valueHolder5a115793d5240139078767;
    }
