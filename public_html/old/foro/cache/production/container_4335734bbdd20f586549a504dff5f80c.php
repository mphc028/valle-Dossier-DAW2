...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'lett_oauth_tokens', 'lett_oauth_states', 'lett_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'lett_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'lett_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'lett_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'lett_forums', 'lett_posts', 'lett_topics', 'lett_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('lett_captcha_questions', 'lett_captcha_answers', 'lett_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'lett_ext', './', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'lett_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'lett_migrations', './', 'php', 'lett_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'lett_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'lett_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'lett_notification_types', 'lett_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'lett_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'lett_notification_types', 'lett_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'lett_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'lett_profile_fields', 'lett_profile_lang', 'lett_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000013b067ef0000000022625d8c(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'lett_bbcodes', 'lett_smilies', 'lett_styles', 'lett_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'lett_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'lett_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'lett_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'lett_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'lett_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'lett_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'lett_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'lett_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'lett_acl_groups',
            'tables.acl_options' => 'lett_acl_options',
            'tables.acl_roles' => 'lett_acl_roles',
            'tables.acl_roles_data' => 'lett_acl_roles_data',
            'tables.acl_users' => 'lett_acl_users',
            'tables.attachments' => 'lett_attachments',
            'tables.auth_provider_oauth_token_storage' => 'lett_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'lett_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'lett_oauth_accounts',
            'tables.banlist' => 'lett_banlist',
            'tables.bbcodes' => 'lett_bbcodes',
            'tables.bookmarks' => 'lett_bookmarks',
            'tables.bots' => 'lett_bots',
            'tables.captcha_qa_questions' => 'lett_captcha_questions',
            'tables.captcha_qa_answers' => 'lett_captcha_answers',
            'tables.captcha_qa_confirm' => 'lett_qa_confirm',
            'tables.config' => 'lett_config',
            'tables.config_text' => 'lett_config_text',
            'tables.confirm' => 'lett_confirm',
            'tables.disallow' => 'lett_disallow',
            'tables.drafts' => 'lett_drafts',
            'tables.ext' => 'lett_ext',
            'tables.extensions' => 'lett_extensions',
            'tables.extension_groups' => 'lett_extension_groups',
            'tables.forums' => 'lett_forums',
            'tables.forums_access' => 'lett_forums_access',
            'tables.forums_track' => 'lett_forums_track',
            'tables.forums_watch' => 'lett_forums_watch',
            'tables.groups' => 'lett_groups',
            'tables.icons' => 'lett_icons',
            'tables.lang' => 'lett_lang',
            'tables.log' => 'lett_log',
            'tables.login_attempts' => 'lett_login_attempts',
            'tables.migrations' => 'lett_migrations',
            'tables.moderator_cache' => 'lett_moderator_cache',
            'tables.modules' => 'lett_modules',
            'tables.notification_types' => 'lett_notification_types',
            'tables.notifications' => 'lett_notifications',
            'tables.poll_options' => 'lett_poll_options',
            'tables.poll_votes' => 'lett_poll_votes',
            'tables.posts' => 'lett_posts',
            'tables.privmsgs' => 'lett_privmsgs',
            'tables.privmsgs_folder' => 'lett_privmsgs_folder',
            'tables.privmsgs_rules' => 'lett_privmsgs_rules',
            'tables.privmsgs_to' => 'lett_privmsgs_to',
            'tables.profile_fields' => 'lett_profile_fields',
            'tables.profile_fields_data' => 'lett_profile_fields_data',
            'tables.profile_fields_options_language' => 'lett_profile_fields_lang',
            'tables.profile_fields_language' => 'lett_profile_lang',
            'tables.ranks' => 'lett_ranks',
            'tables.reports' => 'lett_reports',
            'tables.reports_reasons' => 'lett_reports_reasons',
            'tables.search_results' => 'lett_search_results',
            'tables.search_wordlist' => 'lett_search_wordlist',
            'tables.search_wordmatch' => 'lett_search_wordmatch',
            'tables.sessions' => 'lett_sessions',
            'tables.sessions_keys' => 'lett_sessions_keys',
            'tables.sitelist' => 'lett_sitelist',
            'tables.smilies' => 'lett_smilies',
            'tables.sphinx' => 'lett_sphinx',
            'tables.styles' => 'lett_styles',
            'tables.styles_template' => 'lett_styles_template',
            'tables.styles_template_data' => 'lett_styles_template_data',
            'tables.styles_theme' => 'lett_styles_theme',
            'tables.styles_imageset' => 'lett_styles_imageset',
            'tables.styles_imageset_data' => 'lett_styles_imageset_data',
            'tables.teampage' => 'lett_teampage',
            'tables.topics' => 'lett_topics',
            'tables.topics_posted' => 'lett_topics_posted',
            'tables.topics_track' => 'lett_topics_track',
            'tables.topics_watch' => 'lett_topics_watch',
            'tables.user_group' => 'lett_user_group',
            'tables.user_notifications' => 'lett_user_notifications',
            'tables.users' => 'lett_users',
            'tables.warnings' => 'lett_warnings',
            'tables.words' => 'lett_words',
            'tables.zebra' => 'lett_zebra',
...
class phpbbtemplatetwiglexer_0000000013b067ef0000000022625d8c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a1155eb2ad7d234388993 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a1155eb2ad88608902174 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a1155eb2ad56647542351 = array(
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, 'set_environment', array('env' => $env), $this->initializer5a1155eb2ad88608902174);

        return $this->valueHolder5a1155eb2ad7d234388993->set_environment($env);
    }
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a1155eb2ad88608902174);

        return $this->valueHolder5a1155eb2ad7d234388993->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a1155eb2ad88608902174);

        return $this->valueHolder5a1155eb2ad7d234388993->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a1155eb2ad88608902174 = $initializer;
    }
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, '__get', array('name' => $name), $this->initializer5a1155eb2ad88608902174);

        if (isset(self::$publicProperties5a1155eb2ad56647542351[$name])) {
            return $this->valueHolder5a1155eb2ad7d234388993->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a1155eb2ad7d234388993;
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a1155eb2ad88608902174);
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, '__isset', array('name' => $name), $this->initializer5a1155eb2ad88608902174);
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, '__unset', array('name' => $name), $this->initializer5a1155eb2ad88608902174);
    ...
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, '__clone', array(), $this->initializer5a1155eb2ad88608902174);

        $this->valueHolder5a1155eb2ad7d234388993 = clone $this->valueHolder5a1155eb2ad7d234388993;
    }

    public function __sleep()
    {
        $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, '__sleep', array(), $this->initializer5a1155eb2ad88608902174);

        return array('valueHolder5a1155eb2ad7d234388993');
    }
    ...
    {
        return $this->initializer5a1155eb2ad88608902174;
    }
    ...
    {
        return $this->initializer5a1155eb2ad88608902174 && $this->initializer5a1155eb2ad88608902174->__invoke($this->valueHolder5a1155eb2ad7d234388993, $this, 'initializeProxy', array(), $this->initializer5a1155eb2ad88608902174);
    }
    ...
    {
        return null !== $this->valueHolder5a1155eb2ad7d234388993;
    }
    ...
    {
        return $this->valueHolder5a1155eb2ad7d234388993;
    }
